...
nav.navbar(:class="{zindex: !isMenuClose}")#nav
  router-link(to="/")
    .img-container 
      img(src="../assets/title.png")

  ul.navbar__list(:class="{responsive: !isMenuClose}")#menu
    li.navbar__item
    ...
    li.navbar__item
      router-link(to="/location" class="navbar__link" @click="ShowMobileMenu") 
        p Location
    li.navbar__item
      router-link(to="/episode" class="navbar__link" @click="ShowMobileMenu")
        p Episode
...
.navbar__link:hover
  text-shadow: 0px 0px 40px #08b2c9
  transform: scale(1.1)
